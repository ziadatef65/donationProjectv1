...
class DeliveryUserScreen extends StatelessWidget {
          ...
          children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('On this page, information about deliveries will be displayed',style: GoogleFonts.heebo(fontSize: 24,fontWeight: FontWeight.bold,color: Colors.white),textAlign: TextAlign.center,)
                    ],
                  ),
                ),
              ),
            ...
            StreamBuilder<QuerySnapshot>(
              stream: FirebaseFirestore.instance
                  ...
                  .where('superAdmin', isEqualTo: null )
                  .snapshots(),
                  ...
                  return Container(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return
                          user['isDelivery']==true && user['superAdmin']==null?
                          Padding(
                          padding: const EdgeInsets.all(20),
                          child: Column(
                            children: [
